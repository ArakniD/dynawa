dynawa.version = {wristOS="0.6", settings_revision = 20100430}
...
if not dynawa.settings or dynawa.settings.revision < dynawa.version.settings_revision then
	dynawa.settings = {
		...
		autostart = {"/_sys/apps/clock/clock_app.lua","/_sys/apps/bluetooth_apps/openwatch_bt_app.lua","/apps/bt/echo_bt_app.lua"},
